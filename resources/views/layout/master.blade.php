...
<head>
    ...
    <!-- vaficon -->
    <!-- <link rel="shortcut icon" href="public/img/"> -->
    <!-- font -->
    <link
    ...
    <meta name="description"
        content="Membantu mempertemukan anda dengan petani untuk bersama menciptakan pertanian berdampak sosisal dan ekonomi dengan memberdayakan masyarakat pengangguran dan petani rural. Mulai dari 10 ribu anda sudah bisa bertani secara online">

    <!-- Navbar -->
    <!-- Navbar -->
    <nav class="header shadow navbar navbar-expand-lg navbar-light">
        <div class="container">
...
<footer>
    ...
    <div class="page-footer color-green mt-5 text-center">
        <h1 class="text-white footer-text">Mau Tau Informasi Menarik<br>Tentang Peternakan?</h1>
...
<script type="text/javascript">
    $(window).scroll(function() {
        if ($(window).scrollTop() > 90) {
            ...
            // $('.navbar-brand').addClass('font-dark');?\
            // $('.nav-link').addClass('font-dark');
            ...
            // $('.navbar-brand').removeClass('font-dark');
            // $('.nav-link').removeClass('font-dark');
